...
func (_c *UserCreate) AddSessions(v ...*ChatSession) *UserCreate {
...
func (_c *UserCreate) AddSearchHistoryIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddSearchHistoryIDs(ids...)
	return _c
}

// AddSearchHistory adds the "search_history" edges to the SearchHistory entity.
func (_c *UserCreate) AddSearchHistory(v ...*SearchHistory) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSearchHistoryIDs(ids...)
}

// SetPreferencesID sets the "preferences" edge to the UserPreference entity by ID.
func (_c *UserCreate) SetPreferencesID(id uuid.UUID) *UserCreate {
...
func (_c *UserCreate) SetNillablePreferencesID(id *uuid.UUID) *UserCreate {
	if id != nil {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SearchHistoryIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
