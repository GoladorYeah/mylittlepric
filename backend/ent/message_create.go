...
func (_c *MessageCreate) SetResponseType(v string) *MessageCreate {
	_c.mutation.SetResponseType(v)
	return _c
}

// SetNillableResponseType sets the "response_type" field if the given value is not nil.
func (_c *MessageCreate) SetNillableResponseType(v *string) *MessageCreate {
	if v != nil {
...
func (_c *MessageCreate) SetQuickReplies(v []string) *MessageCreate {
	_c.mutation.SetQuickReplies(v)
	return _c
}

// SetProducts sets the "products" field.
func (_c *MessageCreate) SetProducts(v []map[string]interface{}) *MessageCreate {
	_c.mutation.SetProducts(v)
	return _c
}

// SetSearchInfo sets the "search_info" field.
func (_c *MessageCreate) SetSearchInfo(v map[string]interface{}) *MessageCreate {
	_c.mutation.SetSearchInfo(v)
	return _c
}
...
func (_c *MessageCreate) SetSession(v *ChatSession) *MessageCreate {
